...
<div class="page">
  ...
  <div class='row'>
    <div class='col-md-12 content bullhorntext text-center col-lg-6 col-lg-offset-3'>
      <img src="img/bullhorn-logo-drops.png" class="center-block" style="height:250px; margin-top:20px; width:auto;">
...
<div class="row fixbackground">
  <div class="water-image"> <img src="img/water-effect-new.png"></div>
...
<div class="col-md-10 col-md-offset-2 buttons">

      <div class='col-md-3 prijs1'>
        <div class="col-md-10 col-md-offset-1 block">
            <h3 class="text-center">€2.500</h3>
            <p>Basis vacature integratie met de website</p>
            <div class="spacemobiel"></div>
      </div>
      </div>
      <div class='col-md-3 prijs2'>
        <div class="col-md-10 col-md-offset-1 block">
