...
<head>
   <link rel="stylesheet" type="text/css" href="css/bullhorn2.min.css">
</head>
         ...
         <div class="main">
            <div class='row'>
               <div class='col-md-12 content bullhorntext text-center col-lg-6 col-lg-offset-3'>
                  <img src="img/bullhorn-logo-drops.png" class="center-block" style="height:200px; margin-top:20px; margin-bottom: 20px; width:auto;">
               </div>
            </div>
         </div>
         <div class="main">
