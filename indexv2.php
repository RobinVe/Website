...
<div class="container-fluid">
   <div class="row">
      ...
      <div class='double-slide' id='Procces'>
         ...
         <div class='main'>
            <div class='col-md-10 col-md-offset-1 flex' style='min-height:50vh;'>
               <div class='col-md-4 col-xs-12 flex-center' style='min-height: 40vh;'>
            ...
            <div class='row'>
               ...
               <div class='col-md-6 col-md-offset-3 col-xs-12 fullservicepara'>
                  ...
                  <p>Wanneer u complexere wensen heeft zoals bijvoorbeeld het koppelen van een CRM of leverancier software dan krijgt u korting die bij het pakket hoort.
                     Hieronder een duidelijk overzicht van de all-in service componenten per pakket:
                  </p>
               </div>
            </div>
         </div>
      ...
      <div id='Contact' class='single-slide flex' >
         <div class='col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1 flex-center'>
