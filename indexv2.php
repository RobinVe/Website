...
<span>Het wijzigen van teksten</span></li>
					<li><i class="fa fa-check-circle-o" aria-hidden="true"></i>
<span>Aanpassingen voor e-mailboxen</span></li>
					<li><i class="fa fa-check-circle-o" aria-hidden="true"></i>
<span>Foto’s en video’s wijzigen</span></li>
					<li><i class="fa fa-check-circle-o" aria-hidden="true"></i>
<span>Pagina’s toevoegen, aanpassen of verwijderen</span></li>
					<li><i class="fa fa-check-circle-o" aria-hidden="true"></i>
<span>Google Analytics</span></li>
				</ul>
			</div>
		</div>
		<div class='row stripe'>
